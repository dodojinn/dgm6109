...
function makeDrawing (canvas, choice1, x1, y1, choice2, x2, y2, showOrigin) {
    ...
    } else if (choice1 == "elephant") {
        elephant(item1, x1, y1, showOrigin);
    } else if (choice1 == "fish") {
        fish(item1, x1, y1, showOrigin);
    } else if (choice1 == "rabbit") {
        rabbit(item1, x1, y1, showOrigin);
    } else if (choice1 == "dog") {
    ...
    } else if (choice2 == "elephant") {
        elephant(item2, x2, y2, showOrigin);
    } else if (choice2 == "fish") {
        fish(item2, x2, y2, showOrigin);
    } else if (choice2 == "rabbit") {
        rabbit(item2, x2, y2, showOrigin);
    } else if (choice2 == "dog") {
